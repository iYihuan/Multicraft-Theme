...
$this->menu=array(
    array(
        'label'=>Yii::t('mc', '<i class="fa fa-trash" style="color:#e14142;"></i> '.Yii::t('mc', 'Delete User')),
        'url'=>'#',
        'linkOptions'=>array(
...
if (Yii::app()->user->isSuperuser()  && !$model->isNewRecord)
{
    ...
    {
        $this->menu[] = array(
                'label'=>Yii::t('mc', '<i class="fa fa-key"></i> '.Yii::t('mc', 'Generate API Key')),
                'url'=>'#',
                'linkOptions'=>array(
    ...
    {
        $this->menu[] = array(
                'label'=>Yii::t('mc', '<i class="fa fa-trash" style="color:#e14142;"></i> '.Yii::t('mc', 'Remove API Key')),
                'url'=>'#',
                'linkOptions'=>array(
                    'submit'=>array('view','id'=>$model->id),
