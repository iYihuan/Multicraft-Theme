...
$this->menu=array(
    array(
        'label'=>Yii::t('mc', '<i class="fa fa-bars"></i> '.Yii::t('mc', 'Welcome')),
        'url'=>array('', 'view'=>'home'),
    ),
    array(
        'label'=>Yii::t('mc', '<i class="fa fa-search"></i> '.Yii::t('mc', 'Help')),
        'url'=>'#',
        'linkOptions'=>array(
    ...
    array(
        'label'=>Yii::t('mc', '<i class="fa fa-question-circle"></i> '.Yii::t('mc', 'About')),
