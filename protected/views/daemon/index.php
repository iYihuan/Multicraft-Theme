...
$this->menu=array(
        array(
            'label'=>Yii::t('admin', '<i class="fa fa-arrow-up"></i> '.Yii::t('admin', 'Update Minecraft')),
            'url'=>array('daemon/updateMC'),
        ),
        array(
            'label'=>Yii::t('admin', '<i class="fa fa-check-circle"></i> '.Yii::t('admin', 'Multicraft Status')),
            'url'=>array('daemon/status'),
        ),
        array(
            'label'=>Yii::t('admin', '<i class="fa fa-cogs"></i> '.Yii::t('admin', 'Panel Configuration')),
            'url'=>array('daemon/panelConfig'),
        ),
        array(
            'label'=>Yii::t('admin', '<i class="fa fa-signal"></i> '.Yii::t('admin', 'Statistics')),
            'url'=>array('daemon/statistics'),
        ),
        array(
            'label'=>Yii::t('admin', '<i class="fa fa-exclamation-triangle"></i> '.Yii::t('admin', 'Operations')),
            'url'=>array('daemon/operations'),
        ),
        array(
            'label'=>Yii::t('admin', '<i class="fa fa-file-code-o"></i> '.Yii::t('mc', 'Config File Settings')),
