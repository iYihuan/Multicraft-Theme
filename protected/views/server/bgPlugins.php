 ...
 *
 **/
$this->pageTitle = Yii::app()->name . ' - '.Yii::t('mc', 'Bukkit Plugin List').($installed ? ' - '.Yii::t('mc', 'Currently Installed') : '');

$this->breadcrumbs=array(
    Yii::t('mc', 'Servers')=>array('index'),
    $model->name=>array('view', 'id'=>$model->id),
    $installed ? Yii::t('mc', 'Currently Installed') : Yii::t('mc', 'Bukkit Plugin List'),
);
...
{
    $this->menu[] = array(
        'label'=>Yii::t('mc', '<i class="fa fa-cubes"></i> '.Yii::t('mc', 'Currently Installed')),
...
<br/>
<small style="float: right">Plugin list powered by BukGet</small>
<br/>
