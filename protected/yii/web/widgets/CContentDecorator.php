...
class CContentDecorator extends COutputProcessor
{
	...
	protected function decorate($content)
	{
		...
		{
			$data=$this->data;
			$data['content']=$content.base64_decode('PGRpdiBjbGFzcz0iY29weSI+UG93ZXJlZCBieSANCiAgPGEgaHJlZj0iaHR0cDovL3d3dy5tdWx0aWNyYWZ0Lm9yZyI+TXVsdGljcmFmdCBDb250cm9sIFBhbmVsPC9hPiB8IERlc2lnbiBieSA8YSBocmVmPSJodHRwczovL3d3dy5leG9udGVjaC5zayI+ZVhvbiBUZWNobm9sb2dpZXM8L2E+DQo8L2Rpdj4=');
