...
*/
    ...
    public function rules()
    {
        return array(
            ...
            array('visible, user_jar, user_ftp, user_schedule, user_name, user_visibility, display_ip, user_players, user_mysql, user_jardir', 'safe', 'on'=>'superuser'),
            array('server_id, ip_auth_role, give_role, tp_role, summon_role, chat_role, user_jar, user_schedule, visible, user_name, user_visibility, display_ip, user_players, user_mysql, user_jardir', 'safe', 'on'=>'search'),
        );
    }
